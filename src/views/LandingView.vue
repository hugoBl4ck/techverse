...
<template>
  <div class="relative bg-background overflow-hidden">
    ...
    <div class="fixed top-4 left-0 right-0 z-50 flex justify-center px-4">
      <nav
        class="w-full max-w-5xl bg-white/50 backdrop-blur-xl rounded-2xl shadow-lg border border-white/20 px-4 py-3 flex items-center justify-between transition-all duration-300 hover:shadow-xl hover:bg-white/80">
        ...
        <div class="flex items-center gap-3">
          <Button @click="navigateToLogin" variant="ghost" size="sm"
          ...
          <router-link to="/dashboard">
            <div class="relative group cursor-pointer">
              <div
                class="absolute -inset-0.5 bg-gradient-to-r from-orange-400 via-red-500 to-purple-600 rounded-lg blur opacity-60 group-hover:opacity-100 transition duration-200">
              </div>
              <button
                class="relative px-6 py-2 bg-black rounded-lg leading-none flex items-center divide-x divide-gray-600">
    ...
    <section class="relative border-b border-border/40 shadow-sm pt-32 pb-20 overflow-hidden">
      <div class="absolute inset-0 z-0">
        <div class="absolute inset-0 bg-cover bg-center opacity-80"
          style="background-image: url('/bgwhitewallpaperhero.png');"></div>
        <div class="absolute inset-0 bg-gradient-to-b from-transparent via-white/0 to-background"></div>
        <div class="absolute inset-0 bg-gradient-to-r from-white/40 via-white/10 to-transparent backdrop-blur-[0.5px]">
        </div>
      </div>
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div class="text-center lg:text-left">
            <div
              class="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-primary/30 bg-primary/10 backdrop-blur mb-8 animate-fade-in">
            ...
            <h1 class="font-display text-5xl md:text-7xl font-bold text-foreground mb-6 leading-tight drop-shadow-lg">
              Gerencie seu <br />
              <span
                class="bg-clip-text text-transparent bg-gradient-to-r from-primary via-accent to-purple-600 drop-shadow-md">Império
                Tech</span>
            </h1>

            <p
              class="text-lg md:text-xl text-slate-700 mb-10 max-w-2xl mx-auto lg:mx-0 font-body leading-relaxed drop-shadow-sm">
              Do cadastro de clientes à montagem de PCs com IA. O
              <span class="text-foreground font-semibold">TechVerse</span> é a plataforma definitiva para técnicos que
              buscam eficiência e profissionalismo.
            </p>

            <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <Button @click="navigateToApp" size="lg"
              ...
              <Button @click="navigateToLogin" variant="outline" size="lg"
          ...
          <div class="relative hidden lg:block">
            ...
            <div class="relative z-10 animate-float">
              <div
                class="absolute -inset-4 bg-gradient-to-r from-primary/30 to-accent/30 rounded-full blur-3xl opacity-40 animate-pulse">
              </div>
              <img src="/gamer-girl-hero.png" alt="Gamer Girl Tech Setup"
              ...
              <div
                class="absolute -right-8 top-20 bg-white/10 backdrop-blur-md border border-white/20 p-4 rounded-2xl shadow-xl animate-float"
              ...
              <div
                class="absolute -left-4 bottom-20 bg-white/10 backdrop-blur-md border border-white/20 p-4 rounded-2xl shadow-xl animate-float"
    ...
    <section class="py-24 px-4 sm:px-6 lg:px-8 relative">
      <div class="max-w-7xl mx-auto">
        <div class="text-center mb-20">
          <p class="text-sm font-semibold text-primary mb-4 font-body uppercase tracking-wider">
            Poderosa & Intuitiva
          </p>
          <h2 class="font-display text-5xl md:text-6xl font-bold text-foreground mb-6">
            Sua Bancada de
            <span class="bg-clip-text text-transparent bg-gradient-to-r from-primary to-accent">Trabalho Digital</span>
          </h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div @mouseenter="hoveredFeature = 1" @mouseleave="hoveredFeature = null"
            @click="navigateToFeature('gestao-clientes')" class="group relative">
            <Card
              ...
              :class="hoveredFeature === 1
                ? 'shadow-2xl shadow-primary/20'
                : 'shadow-lg shadow-foreground/5'
                ">
              <!-- Animated background on hover -->
              <div v-if="hoveredFeature === 1"
              ...
              <h3 class="font-display text-2xl font-bold text-foreground text-center mb-4">
                Gestão de Clientes
              </h3>
              <p class="text-sm text-muted-foreground text-center font-body leading-relaxed mb-6">
          ...
          <div @mouseenter="hoveredFeature = 2" @mouseleave="hoveredFeature = null"
            @click="navigateToFeature('importacao-ia')" class="group relative md:scale-105 md:translate-y-8">
            <Card
              ...
              :class="hoveredFeature === 2
                ? 'shadow-2xl shadow-accent/20'
                : 'shadow-lg shadow-foreground/5'
                ">
              <!-- Animated background on hover -->
              <div v-if="hoveredFeature === 2"
          ...
          <div @mouseenter="hoveredFeature = 3" @mouseleave="hoveredFeature = null"
            @click="navigateToFeature('canvas-montagem')" class="group relative">
            <Card
              ...
              :class="hoveredFeature === 3
                ? 'shadow-2xl shadow-secondary/20'
                : 'shadow-lg shadow-foreground/5'
                ">
              <!-- Animated background on hover -->
              <div v-if="hoveredFeature === 3"
          ...
          <div class="relative z-10">
            <div class="text-center mb-8">
              <span
                ...
                <span class="text-accent font-semibold font-body text-sm">⚡ Serviço Premium de Otimização</span>
              </span>
            </div>
            ...
            <h3 class="font-display text-4xl md:text-5xl font-bold text-foreground mb-6 text-center">
              Seu PC está
              <span class="bg-clip-text text-transparent bg-gradient-to-r from-accent to-primary">100% Otimizado</span>?
            </h3>
                ...
                <div class="space-y-6">
                  <div class="flex gap-4 p-4 rounded-xl bg-green-500/5 border border-green-500/20">
                    ...
                    <div>
                      ...
                      <p class="text-sm text-muted-foreground">
                        Análise via IA + Especialista para ativar Resize BAR
                        <Tooltip text="Tecnologia que permite acesso direto à memória da GPU" />, PBO e curvas de fan
                        customizadas.
                      </p>
                    </div>
                  </div>
            ...
            <div class="mb-8 fade-in">
              <Card class="p-6 bg-background/50 border border-border/50 card-premium">
                <h4 class="font-display text-xl font-bold text-foreground mb-4 text-center">Descubra se seu PC precisa
                  de otimização</h4>
                <div v-if="quizStep < 3" class="text-center">
                  <!-- Progress Indicator -->
                  <div class="mb-6">
                    <div class="flex justify-center items-center gap-2 mb-2">
                      <div v-for="step in 3" :key="step" class="w-3 h-3 rounded-full"
                        :class="step <= quizStep + 1 ? 'bg-accent' : 'bg-muted-foreground/30'"></div>
                    </div>
                  ...
                  <div v-if="quizStep === 0" role="radiogroup" aria-labelledby="quiz-q1">
                    ...
                    <div class="flex flex-col sm:flex-row gap-2 justify-center">
                      <Button @click="answerQuiz('gaming')"
                        :variant="selectedAnswer === 'gaming' ? 'default' : 'outline'" class="flex-1"
                        :class="selectedAnswer === 'gaming' ? 'bg-accent text-white' : ''">Jogos e
                        entretenimento</Button>
                      <Button @click="answerQuiz('work')" :variant="selectedAnswer === 'work' ? 'default' : 'outline'"
                        class="flex-1" :class="selectedAnswer === 'work' ? 'bg-accent text-white' : ''">Trabalho
                        profissional</Button>
                      <Button @click="answerQuiz('general')"
                        :variant="selectedAnswer === 'general' ? 'default' : 'outline'" class="flex-1"
                        :class="selectedAnswer === 'general' ? 'bg-accent text-white' : ''">Uso geral</Button>
                    </div>
                  </div>
                  <div v-if="quizStep === 1" role="radiogroup" aria-labelledby="quiz-q2">
                    ...
                    <div class="flex flex-col sm:flex-row gap-2 justify-center">
                      <Button @click="answerQuiz('frequent')"
                        :variant="selectedAnswer === 'frequent' ? 'default' : 'outline'" class="flex-1"
                        :class="selectedAnswer === 'frequent' ? 'bg-accent text-white' : ''">Frequentemente</Button>
                      <Button @click="answerQuiz('sometimes')"
                        :variant="selectedAnswer === 'sometimes' ? 'default' : 'outline'" class="flex-1"
                        :class="selectedAnswer === 'sometimes' ? 'bg-accent text-white' : ''">Às vezes</Button>
                      <Button @click="answerQuiz('rarely')"
                        :variant="selectedAnswer === 'rarely' ? 'default' : 'outline'" class="flex-1"
                        :class="selectedAnswer === 'rarely' ? 'bg-accent text-white' : ''">Raramente</Button>
                    </div>
                  </div>
                  <div v-if="quizStep === 2" role="radiogroup" aria-labelledby="quiz-q3">
                    ...
                    <div class="flex flex-col sm:flex-row gap-2 justify-center">
                      <Button @click="answerQuiz('yes')" :variant="selectedAnswer === 'yes' ? 'default' : 'outline'"
                        class="flex-1" :class="selectedAnswer === 'yes' ? 'bg-accent text-white' : ''">Sim, já
                        tentei</Button>
                      <Button @click="answerQuiz('no')" :variant="selectedAnswer === 'no' ? 'default' : 'outline'"
                        class="flex-1" :class="selectedAnswer === 'no' ? 'bg-accent text-white' : ''">Não,
                        nunca</Button>
                      <Button @click="answerQuiz('unsure')"
                        :variant="selectedAnswer === 'unsure' ? 'default' : 'outline'" class="flex-1"
                        :class="selectedAnswer === 'unsure' ? 'bg-accent text-white' : ''">Não tenho certeza</Button>
                    </div>
                  </div>
                </div>
                <div v-else class="text-center animate-fade-in">
                  ...
                  <div class="flex flex-col gap-3">
                    <Button
                      class="w-full bg-green-600 hover:bg-green-700 text-white font-bold shadow-lg hover:shadow-green-500/20 transition-all"
                      @click="contactSpecialist">
                      <MessageCircle class="w-4 h-4 mr-2" />
                      Falar com Especialista
                    </Button>
                    <Button @click="resetQuiz" variant="ghost" size="sm"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 mb-12">
              <div class="text-center animate-fade-in" style="animation-delay: 0.2s">
                ...
                <p class="text-sm text-muted-foreground">Que sabem que seu setup pode rodar jogos em máxima performance
                </p>
              </div>
            ...
            <div class="max-w-4xl mx-auto mb-12">
              <div class="relative overflow-hidden rounded-2xl border border-border/50 shadow-2xl shadow-primary/10">
                ...
                <div class="relative h-80 md:h-96 transition-all duration-500">
                  <div :key="currentTestimonial" class="absolute inset-0 transition-opacity duration-500">
                    <div class="relative w-full h-full rounded-2xl overflow-hidden" :style="{
                      ...
                      <div class="relative z-10 flex flex-col justify-center items-center h-full p-8 text-center">
                        <div class="flex justify-center mb-4">
                          <div
                            :class="`w-14 h-14 rounded-full ${testimonials[currentTestimonial].color}/20 flex items-center justify-center`">
                            <User class="w-7 h-7"
                              :class="`text-${testimonials[currentTestimonial].color.replace('bg-', '')}`" />
                          </div>
                        </div>
                        <h4 class="font-semibold text-white mb-4 text-lg">{{ testimonials[currentTestimonial].name }}
                        </h4>
                        <p class="text-sm md:text-base text-gray-200 max-w-2xl">{{ testimonials[currentTestimonial].text
                          }}</p>
                      </div>
                    </div>
                  </div>
                ...
                <div class="absolute bottom-4 left-1/2 -translate-x-1/2 z-20 flex gap-2">
                  <button v-for="(testimonial, index) in testimonials" :key="index" @click="goToTestimonial(index)"
                    ...
                    ]" :aria-label="`Ir para depoimento ${index + 1}`" :aria-current="index === currentTestimonial" />
                </div>
              </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              <div class="relative overflow-hidden rounded-lg shadow-lg">
                <img src="/Captura-de-tela-comparativo-pbo.png"
                  alt="Gráfico de benchmark mostrando ganhos de performance com PBO ativado."
                  class="w-full h-48 object-cover" />
                <div class="absolute inset-0 bg-gradient-to-br from-primary/40 to-accent/40"></div>
              </div>
              <div class="relative overflow-hidden rounded-lg shadow-lg">
                <img src="/Captura-de-tela-comparativo-pbo1.png"
                  alt="Tela de configuração da BIOS com a opção Precision Boost Overdrive destacada."
                  class="w-full h-48 object-cover" />
                <div class="absolute inset-0 bg-gradient-to-br from-primary/40 to-accent/40"></div>
              </div>
              <div class="relative overflow-hidden rounded-lg shadow-lg">
                <img src="/Captura-de-tela-comparativo-pbo2.png"
                  alt="Comparativo de temperatura do processador antes e depois da otimização PBO."
                  class="w-full h-48 object-cover" />
                <div class="absolute inset-0 bg-gradient-to-br from-primary/40 to-accent/40"></div>
              </div>
            </div>

            <div class="flex flex-col sm:flex-row gap-4 justify-center items-center fade-in ab-test-variant-a"
              style="animation-delay: 1.8s">
              <Button @click="() => { navigateToOtimizacao(); }"
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm text-muted-foreground">
                <div class="flex items-start gap-3 card-premium p-4 rounded-lg">
                  ...
                  <div>
                    ...
                    <p>Suportamos desktops, notebooks gamers, workstations e setups customizados. Para notebooks com
                      BIOS limitado, oferecemos alternativas seguras.</p>
                  </div>
                </div>
                <div class="flex items-start gap-3 card-premium p-4 rounded-lg">
                  ...
                  <div>
                    ...
                    <p>Processo adaptado para usuários com necessidades especiais. Suporte remoto completo e orientações
                      passo-a-passo.</p>
                  </div>
                </div>
              </div>
    ...
    <!-- Monetização      <!-- Promoções Section - Compacta e Atraente -->
    <section class="py-16 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      <!-- Background animado -->
      <div class="absolute inset-0 bg-gradient-to-br from-orange-500/5 via-background to-purple-600/5 -z-10"></div>
      <div class="absolute inset-0 bg-[url('/grid.svg')] opacity-5 -z-10"></div>

      <div class="max-w-5xl mx-auto">
        <Card
          class="relative overflow-hidden p-8 md:p-12 bg-gradient-to-br from-background/95 via-background/90 to-background/95 border-2 border-orange-500/30 backdrop-blur-xl shadow-2xl shadow-orange-500/10">
          <!-- Glow effect -->
          <div
            class="absolute top-0 right-0 w-64 h-64 bg-gradient-to-br from-orange-500/20 to-purple-600/10 rounded-full blur-3xl -z-10 opacity-40 animate-pulse">
          </div>
          ...
          <div class="relative z-10">
            ...
            <div class="flex justify-center mb-6">
              <span
                class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-orange-500/20 to-red-500/20 border border-orange-500/40">
                <span class="relative flex h-2 w-2">
                  <span
                    class="animate-ping absolute inline-flex h-full w-full rounded-full bg-orange-500 opacity-75"></span>
                  <span class="relative inline-flex rounded-full h-2 w-2 bg-orange-500"></span>
                </span>
                <span class="text-orange-600 dark:text-orange-400 font-bold font-body text-sm">Ofertas Exclusivas</span>
              </span>
            </div>

            <!-- Título -->
            <h3 class="font-display text-3xl md:text-4xl font-bold text-foreground mb-4 text-center">
              <span
                class="bg-clip-text text-transparent bg-gradient-to-r from-orange-500 via-red-500 to-purple-600">Hardware
                Premium</span> com Desconto
            </h3>

            <!-- Descrição compacta e persuasiva -->
            <p
              class="text-base md:text-lg text-muted-foreground text-center font-body mb-8 leading-relaxed max-w-2xl mx-auto">
              Acesse <span class="font-semibold text-foreground">promoções curadas</span> de componentes de alta
              performance.
              Economize em <span class="font-semibold text-orange-600 dark:text-orange-400">GPUs, CPUs, SSDs</span> e
              mais.
              <span class="block mt-2 text-sm text-muted-foreground/80">TechVerse é gratuito. Ganhamos uma pequena
                comissão em compras via nossos links.</span>
            </p>

            <!-- CTAs -->
            <div class="flex flex-col sm:flex-row gap-3 justify-center items-center">
              <router-link to="/promocoes" class="w-full sm:w-auto">
                <Button
                  class="w-full font-body bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 hover:shadow-xl hover:shadow-orange-500/30 text-white border-0 h-12 px-8 rounded-full transition-all group">
                  Ver Promoções Agora
    ...
    <section class="py-24 px-4 sm:px-6 lg:px-8 relative">
      <div class="max-w-4xl mx-auto text-center">
        <h2 class="font-display text-5xl md:text-6xl font-bold text-foreground mb-6">
          Pronto para
          <span
            class="bg-clip-text text-transparent bg-gradient-to-r from-primary via-accent to-primary">transformar</span>
          seu fluxo de trabalho?
        </h2>
        <p class="text-xl text-muted-foreground mb-10 font-body max-w-2xl mx-auto">
    ...
    <!-- Footer com Degradê Premium -->
    <footer class="relative z-10 overflow-hidden">
      <!-- Degradê de fundo -->
      <div class="absolute inset-0 bg-gradient-to-br from-purple-600/10 via-background to-orange-500/10"></div>
      <div class="absolute inset-0 bg-gradient-to-t from-purple-900/20 via-transparent to-transparent"></div>

      <!-- Conteúdo -->
      <div class="relative border-t border-border/30 backdrop-blur-sm py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-7xl mx-auto">
          <!-- Grid de Links -->
          <div class="grid grid-cols-2 md:grid-cols-4 gap-8 mb-10 pb-8 border-b border-border/20">
            <!-- Coluna 1: Marca -->
            <div class="col-span-2 md:col-span-1">
              <div class="flex items-center gap-2 mb-4">
                <div
                  class="w-8 h-8 rounded-lg bg-gradient-to-br from-primary to-accent flex items-center justify-center">
                  <img src="/techLOGO.svg" alt="TechVerse Logo" class="w-5 h-5 invert" />
                </div>
                <span
                  class="font-display text-lg font-bold bg-clip-text text-transparent bg-gradient-to-r from-primary to-accent">TechVerse</span>
              </div>
              <p class="text-sm text-muted-foreground leading-relaxed">
                Plataforma completa para técnicos de TI. Gestão, IA e otimização em um só lugar.
              </p>
            </div>
            ...
            <div>
              ...
              <ul class="space-y-2 text-sm">
                <li><router-link to="/otimizacao"
                    class="text-muted-foreground hover:text-primary transition-colors">Otimização</router-link></li>
                <li><router-link to="/promocoes"
                    class="text-muted-foreground hover:text-primary transition-colors">Promoções</router-link></li>
                <li><router-link to="/noticias"
                    class="text-muted-foreground hover:text-primary transition-colors">Notícias</router-link></li>
                <li><router-link to="/ranking-cpu"
                    class="text-muted-foreground hover:text-primary transition-colors">Ranking CPU</router-link></li>
              </ul>
            </div>

            <!-- Coluna 3: Recursos -->
            <div>
              <p class="font-semibold text-foreground mb-3 text-sm">Recursos</p>
              <ul class="space-y-2 text-sm">
                <li><router-link to="/dashboard"
                    class="text-muted-foreground hover:text-primary transition-colors">Dashboard</router-link></li>
                <li><router-link to="/clientes"
                    class="text-muted-foreground hover:text-primary transition-colors">Clientes</router-link></li>
                <li><router-link to="/inventario"
                    class="text-muted-foreground hover:text-primary transition-colors">Inventário</router-link></li>
                <li><router-link to="/kits"
                    class="text-muted-foreground hover:text-primary transition-colors">Kits</router-link></li>
              </ul>
            </div>

            <!-- Coluna 4: Comunidade -->
            <div>
              <p class="font-semibold text-foreground mb-3 text-sm">Comunidade</p>
              <ul class="space-y-2 text-sm">
                <li><router-link to="/donate"
                    class="text-muted-foreground hover:text-primary transition-colors flex items-center gap-1">
                    <Coffee class="w-3 h-3" /> Apoie
                  </router-link></li>
                <li><span class="text-muted-foreground/50">Discord (em breve)</span></li>
                <li><span class="text-muted-foreground/50">Blog (em breve)</span></li>
              </ul>
            </div>
          </div>
          ...
          <div class="text-center">
            <p class="text-sm text-muted-foreground font-body">
              © {{ new Date().getFullYear() }} <span class="font-semibold text-foreground">TechVerse</span>.
              Desenvolvido com <span class="text-red-500">❤️</span> por <span
                class="font-semibold bg-clip-text text-transparent bg-gradient-to-r from-primary to-accent">HugoBl4ck</span>
            </p>
            <p class="text-xs text-muted-foreground/70 mt-2">Todos os direitos reservados.</p>
          </div>
        </div>
      </div>
    </footer>
