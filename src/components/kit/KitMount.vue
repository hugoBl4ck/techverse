...
async function saveKitToInventory() {
  const assembledKit = {
    ...
    watercooler: props.kit.slots.watercooler[0] || null,
    aircooler: props.kit.slots.aircooler[0] || null,
    ventoinhas: props.kit.slots.ventoinhas,
    pastaTermica: props.kit.slots.pastaTermica[0] || null,
    mouse: props.kit.slots.mouse[0] || null,
    teclado: props.kit.slots.teclado[0] || null,
    controle: props.kit.slots.controle[0] || null,
    controladoras: props.kit.slots.controladoras,
  };
    ...
    <CardContent class="p-4">
      <div class="grid grid-cols-2 gap-4">
        ...
        <div>
          ...
          <draggable v-model="kit.slots.watercooler" :group="{ name: 'items', put: (to, from, el) => putGenerico(to, from, el, 'watercooler') }" item-key="id" class="min-h-20 p-2 border-2 border-dashed rounded-lg mt-1">
            <template #item="{ element }">
              <ItemChip :item="element" :data-tipo="element.tipo" :data-item="JSON.stringify(element)"/>
            </template>
          </draggable>
        ...
        <div>
          ...
          <draggable v-model="kit.slots.aircooler" :group="{ name: 'items', put: (to, from, el) => putGenerico(to, from, el, 'aircooler') }" item-key="id" class="min-h-20 p-2 border-2 border-dashed rounded-lg mt-1">
            <template #item="{ element }">
              <ItemChip :item="element" :data-tipo="element.tipo" :data-item="JSON.stringify(element)"/>
            </template>
          </draggable>
        ...
        <div>
          ...
          <draggable v-model="kit.slots.ventoinhas" :group="{ name: 'items', put: (to, from, el) => putGenerico(to, from, el, 'ventoinhas') }" item-key="id" class="min-h-20 p-2 border-2 border-dashed rounded-lg mt-1">
            <template #item="{ element }">
              <ItemChip :item="element" :data-tipo="element.tipo" :data-item="JSON.stringify(element)"/>
            </template>
          </draggable>
        ...
        <div>
          ...
          <draggable v-model="kit.slots.pastaTermica" :group="{ name: 'items', put: (to, from, el) => putGenerico(to, from, el, 'pasta termica') }" item-key="id" class="min-h-20 p-2 border-2 border-dashed rounded-lg mt-1">
            <template #item="{ element }">
              <ItemChip :item="element" :data-tipo="element.tipo" :data-item="JSON.stringify(element)"/>
            </template>
          </draggable>
        ...
        <div>
          ...
          <draggable v-model="kit.slots.mouse" :group="{ name: 'items', put: (to, from, el) => putGenerico(to, from, el, 'mouse') }" item-key="id" class="min-h-20 p-2 border-2 border-dashed rounded-lg mt-1">
            <template #item="{ element }">
              <ItemChip :item="element" :data-tipo="element.tipo" :data-item="JSON.stringify(element)"/>
            </template>
          </draggable>
        ...
        <div>
          ...
          <draggable v-model="kit.slots.teclado" :group="{ name: 'items', put: (to, from, el) => putGenerico(to, from, el, 'teclado') }" item-key="id" class="min-h-20 p-2 border-2 border-dashed rounded-lg mt-1">
            <template #item="{ element }">
              <ItemChip :item="element" :data-tipo="element.tipo" :data-item="JSON.stringify(element)"/>
            </template>
          </draggable>
        ...
        <div>
          ...
          <draggable v-model="kit.slots.controle" :group="{ name: 'items', put: (to, from, el) => putGenerico(to, from, el, 'controle') }" item-key="id" class="min-h-20 p-2 border-2 border-dashed rounded-lg mt-1">
            <template #item="{ element }">
              <ItemChip :item="element" :data-tipo="element.tipo" :data-item="JSON.stringify(element)"/>
            </template>
          </draggable>
        ...
        <div>
          ...
          <draggable v-model="kit.slots.controladoras" :group="{ name: 'items', put: (to, from, el) => putGenerico(to, from, el, 'controladoras') }" item-key="id" class="min-h-20 p-2 border-2 border-dashed rounded-lg mt-1">
            <template #item="{ element }">
              <ItemChip :item="element" :data-tipo="element.tipo" :data-item="JSON.stringify(element)"/>
            </template>
          </draggable>
